...
conversation_open_admin_menu = "You are a 💼 <b>pilot</b> of this supply!\n" \
...
conversation_switch_to_user_mode = " You are switching to 👤 Customer mode.\n" \
                                   "If you want to go back to the 💼 pilot menu, restart the conversation with /start."

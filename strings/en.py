...
product_format_string = "{name}\n" \
                        "Vehicle destination: <b>{description}</b>\n" \
                        "{price}\n" \
                        "<b>{cart}</b>"
...
order_format_string = "by {user}\n" \
                      ...
                      "\n" \
                      "Customer UID: {notes}\n"\
                      "Plsease wait at the nearest bus stop and your shuttle shuttle would be available in less than 3 munites"
...
conversation_open_admin_menu = "You are the <b>owner</b> 💼 of this fleet!\n" \
...
conversation_confirm_admin_promotion = "Are you sure you want to promote this user to  a fleet owner 💼?\n" \
...
conversation_switch_to_user_mode = " You are switching to 👤 Customer mode.\n" \
                                   "If you want to go back to the owner 💼 menu, restart the conversation with /start."
...
menu_edit_admins = "🏵 Edit a user status"
...
ask_product_description = "What is the vehicle destination for this ride be?"
...
ask_order_notes = "Input your RFID code?\n" \
                  "💼 It will be visible to the pilot.\n" \
                  "\n" \
...
bot_info = "This bot's <a href='https://github.com/Steffo99/greed'></a>" \
           "framework's is made by @Steffo for Telegram payments released under the" \
           'Affero General Public License 3.0</a>.\n'

# Help: guide
help_msg = "Hopeful's guide is available at this address:\n" \
